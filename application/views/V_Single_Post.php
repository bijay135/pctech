<div id="site_content">
    ...
    <!-- insert the page content here -->
		...
		?>
            ...
            if($is_valid_token['status'] === TRUE){ //if user is logged in, display comment box
            ?>
                <form action="<?=base_url()?>Comments/addComment/<?=$post['post_id']?>" method="post">
            ...
            else{ //if no user is loged in, then show the log in button
            ?>
